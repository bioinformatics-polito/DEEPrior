...
def build_test_set_main_protein():
    fusion_list = []
    version = 'grch37'
    ...
    for i in range(len(file_red)):
        ...
        with open(os.path.join(path, "data/test_set_main_protein.data"), 'wb+') as f:
    ...
    for i in range(len(file)):
        ...
        # TRANSLATE nucleotides sequences into amino acids sequences and add LABELS
        fusion_list[i+len(file_red)].main_protein = main_sequence(fusion_list[i])
    ...
    for i in range(len(file_1)):
        ...
        # TRANSLATE nucleotides sequences into amino acids sequences and add LABELS
        fusion_list[i + len(file_red)+len(file)].main_protein = main_sequence(fusion_list[i])
